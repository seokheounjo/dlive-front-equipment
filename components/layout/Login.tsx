...
interface LoginProps {
  onLogin: (userId?: string, userName?: string, userRole?: string, crrId?: string, soId?: string, mstSoId?: string) => void;
}
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (result.ok) {
        ...
        onLogin(result.userId, result.userName, result.userRole, result.crrId, result.soId, result.mstSoId);
      } else {
