                          ...
                          >
                            ...
                            {viewMode === 'detail' && (
                              <div className="bg-gray-100 rounded-lg p-2 mt-2 text-xs space-y-1 ml-6">
                                <div className="flex items-center justify-between"><span className="text-gray-800">{item.EQT_CL_NM || item.ITEM_MID_CD_NM || '(정보없음)'}</span><span className="font-medium text-gray-800">{selectedEqtOut?.SO_NM || '-'}</span></div>
