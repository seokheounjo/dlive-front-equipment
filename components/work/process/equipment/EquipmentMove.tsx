...
import { ArrowDown, ArrowUp, CheckCircle2, XCircle, Loader2, History, ScanBarcode, Settings } from 'lucide-react';
...
const EquipmentMove: React.FC<EquipmentComponentProps> = ({
  ...
  const handleModelChange = async (selectedEquipmentsFromModal: any[], _selectedPromotionCount?: string) => {
    try {
      ...
      showToast?.(error.message || '장비 구성정보 변경 중 오류가 발생했습니다.', 'error');
      throw error;
    }
  };
