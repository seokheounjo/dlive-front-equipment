...
const EquipmentTerminateForm: React.FC<EquipmentComponentProps> = ({
  workItem,
  onSave,
  onBack,
  showToast,
                ...
                >
                  ...
                  {!isWorkCompleted && !readOnly && (() => {
                    ...
                    <div className="flex flex-wrap gap-2 pt-3 border-t border-gray-100">
                      <label className={`flex items-center gap-1.5 px-2 py-1.5 rounded-lg active:bg-gray-100 whitespace-nowrap ${isCustomerOwned ? 'bg-gray-200 text-gray-400 cursor-not-allowed' : 'cursor-pointer'}`}>
                        <input
                          type="checkbox"
...
export default EquipmentTerminateForm;
