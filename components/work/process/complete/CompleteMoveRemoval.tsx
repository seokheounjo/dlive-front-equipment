            ...
            {isMoveRemoval && (
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
                <p className="text-sm text-blue-800 font-medium">
                  철거이전 작업입니다. 설비이전정보 및 주소변경이 가능합니다.
                </p>
              </div>
            )}
            ...
            <div>
              ...
              <div className="flex gap-2">
                ...
                {isMoveRemoval && !isWorkCompleted && (
                  <button
                    type="button"
                    onClick={() => showToast?.('주소변경 기능은 준비 중입니다.', 'info')}
                    className="px-4 py-2 bg-yellow-500 hover:bg-yellow-600 text-white rounded-lg font-bold text-sm whitespace-nowrap"
                  >
                    주소변경
                  </button>
                )}
