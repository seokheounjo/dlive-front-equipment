...
export const updateInstallAddress = async (params: InstallAddressChangeRequest): Promise<ApiResponse<any>> => {
  ...
  return apiCall<any>('/customer/etc/saveMargeAddrOrdInfo', {
    ...
    STREET_ID: (params.STREET_ID || '').substring(0, 10),
...
export const registerConsultation = async (params: ConsultationRequest): Promise<ApiResponse<any>> => {
  ...
  // CONA classification codes: CMCS010(2chars), CMCS020(3chars), CMCS030(4chars)
  // Pass as-is without truncation (legacy mowoe03m04.xml sends full codes directly)
  return apiCall<any>('/customer/negociation/saveCnslRcptInfo', {
    ...params,
    CNSL_MST_CL: params.CNSL_MST_CL || '',
    CNSL_MID_CL: params.CNSL_MID_CL || '',
    CNSL_SLV_CL: params.CNSL_SLV_CL || '',
    SO_ID: soId,
    MST_SO_ID: mstSoId,
    USR_ID: usrId,
    CRR_ID: crrId,
